    ...
    'zh-CN': [
        ...
        },
        {
          ...
          links: [
            ...
            { title: 'Ownership与结构体、枚举', href: '/docs/core-concept/ownership-with-struct-enum'},
            { title: '流程控制和函数', href: '/docs/core-concept/flow-control-and-functions'},
            { title: 'Error错误处理', href: '/docs/core-concept/error-handling'},
            { title: '借用和生命周期', href: '/docs/core-concept/borrowing-and-lifetime'},
    ...
    "en": [
        ...
        },
        {
            ...
            links: [
              ...
              { title: 'Ownership with Structure and Enumeration', href: '/docs/core-concept/ownership-with-struct-enum'},
              { title: 'Flow Control and Functions', href: '/docs/core-concept/flow-control-and-functions'},
              { title: 'Error Handling', href: '/docs/core-concept/error-handling'},
              { title: 'Borrowing and Lifetime', href: '/docs/core-concept/borrowing-and-lifetime'},
    ...
    "es": [
      {
        ...
        links: [
          ...
          { title: 'Instalación de óxido', href: '/docs/get-started/installation' },
        ],
    },
    {
        title: 'Concepto principal',
        links: [
          { title: 'Descripción general de alto nivel', href: '/docs/core-concept/high-level-overview'},
          { title: 'Tipos de datos comunes', href: '/docs/core-concept/basic-type'},
          { title: 'Propiedad con estructura y enumeración', href: '/docs/core-concept/ownership-with-struct-enum'},
          { title: 'Control de flujo y funciones', href: '/docs/core-concept/flow-control-and-functions'},
          { title: 'Manejo de errores', href: '/docs/core-concept/error-handling'},
          { title: 'Préstamo y vida útil', href: '/docs/core-concept/borrowing-and-lifetime'},
